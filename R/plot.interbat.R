...
#'  }
#'
plot.interbat <- function(x, what = "variables", comps = c(1, 2), where = c("t", 
    "t"), cex = 1, col.xlabels = "#5592e3", col.ylabels = "#e3a654", yfont = 1, pos = NULL, 
    offset = 0.1, col.xarrows = "#5b9cf255", col.yarrows = "#e3a65455", lwd = 3, 
    ...
    if (what == "variables") {
        ...
        # arrows
        arrows(x0 = rep(0, p), y0 = rep(0, p), x1 = x$cor.xu[, k1], y1 = x$cor.xu[, 
            k2], length = length, angle = angle, lwd = lwd, col = c(rep(col.xarrows, 
            p)))
        arrows(x0 = rep(0, p), y0 = rep(0, p), x1 = x$cor.yt[, k1], y1 = x$cor.yt[, 
        ...
        text(x$cor.xu[, k1], x$cor.xu[, k2], labels = rownames(x$cor.xu), col = c(rep(col.xlabels, 
            p)), cex = cex, pos = posx, offset = offset, ...)
        text(x$cor.yt[, k1], x$cor.yt[, k2], labels = rownames(x$cor.yt), font = yfont, 
