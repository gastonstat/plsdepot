...
#'  }
#'
plot.simpls <- function(x, what = "variables", comps = c(1, 2), cex = 1, col.xlabels = "#5592e3", 
    col.ylabels = "#fe9429", yfont = 2, pos = NULL, offset = 0.1, col.xarrows = "#5b9cf255", 
    col.yarrows = "#FE992955", lwd = 3, length = 0, angle = 0, col.points = "#5592e3", 
    pch = 21, pt.bg = "#5b9cf255", show.names = FALSE, xpd = TRUE, xlab = NULL, ylab = NULL, 
    main = NULL, col.main = "gray35", cex.main = 1.2, col.axis = "gray40", show.grid = TRUE, 
    col.grid = "gray95", ...) {
    # ======================================================= check inputs
    # =======================================================
    ...
    if (what == "variables") {
        ...
        # ======================================================= observations
        # ======================================================= plot
        plot(x$x.scores[, k1], x$x.scores[, k2], type = "n", axes = FALSE, xlab = xlab, 
            ylab = ylab, col.lab = col.axis)
        ...
        # points
        if (!show.names) {
            points(x$x.scores[, k1], x$x.scores[, k2], col = col.points, pch = pch, 
                bg = pt.bg, lwd = 1.5, cex = cex)
        } else {
